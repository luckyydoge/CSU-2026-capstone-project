...
@ray.remote
class ProxyActor:
    def __init__(self, submission_id: str = "Unknown",
        ...
        tags = {'actor_id': self.id, 'submission_id': submission_id}
...
class ProxyFactory:
    ...
    @staticmethod
    def create(tasks: List[Callable[..., Any]], submission_id: str) -> List['ray.actor.ActorHandler']:
        retval = [ProxyActor.remote(submission_id, SubmissionType.TASK, task) for task in tasks]
        return retval
